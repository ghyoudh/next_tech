        ...
        <div class="navbar__container">
            ...
            <ul class="navbar__menu">
                ...
                <li class="navbar__btn">
                    <a href="http://localhost/next_tech/login/signup.php"
    ...
    <div class="main">
        <div class="main__container">
            <div class="main__content">
                ...
                <p>Explore the latest advancements in technology that are
                    shaping our future.</p>
                <button class="main__btn"><a
                        href="techNews.php">START</a></button>
            </div>
        </div>
    </div>
        ...
        <div class="footer__container">
            <div class="footer__link--wrapper">
                <div class="footer__about">
                    <h2>About Us</h2>
                    <p> <strong>Next Tech</strong> is your trusted source
                        for the latest news in technology, innovation, and
                        digital trends.
                        Our mission is to keep tech enthusiasts,
                        professionals, and curious minds informed with
                        accurate, up-to-date, and engaging content.</p>
                    <p>Whether it's breakthroughs in AI, futuristic gadgets,
                        cybersecurity updates, or space tech, we cover
                        stories that shape tomorrow's world—today.</p>
                </div>
